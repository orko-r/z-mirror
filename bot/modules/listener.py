...
<<<<<<< HEAD
                    msg += '<b>⏩ Files has been sent in Dump. ⏪</b>'
...
<<<<<<< HEAD
        msg = f"<b>Hey</b> {self.tag} {e_str},\n<b>Remaining Time:</b> {get_readable_time(time() - self.message.date.timestamp())}"
=======
